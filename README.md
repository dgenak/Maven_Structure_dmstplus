...
Αφού έχετε πραγματοποιήσει να προηγούμενα βήματα, μπορείτε να εκτελέσετε το πρόγραμμα με τρείς εντολές:
  ...
  Εντολή 2:
    ...
    mvn exec:java
  Αν για κάποιο λόγο δεν δουλέψουν οι προηγούμενες εντολές τότε μπορείτε να δοκιμάσετε και αυτή που είναι πιο συγκεκριμένη:
...
## Αλγόριθμοι/Μέθοδοι:
  Η εφαρμογή DMSTPLUS αποτελείται από πολλές μεθόδους, οι οποίες όμως έχουν μικρή λειτουργική σημασία. Η κύρια μέθοδος της εφαρμογής είναι η letsGoErasmus, η οποία ελέγχει αν τα πανεπιστήμια ταιριάζουν με τις προτιμήσεις του χρήστη
