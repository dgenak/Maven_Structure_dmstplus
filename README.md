...
## Δομές Δεδομένων:
  ...
  - List< τύπου String: Χώρες και γλώσσες που γνωρίζει ο χρήστης.
    
  - List τύπου University: Πανεπιστήμια με πληροφορίες όπως κόστος, γλώσσα και περίοδος.
    
  - List τύπου Languages , List τύπου Countries: Γλώσσες και χώρες για τις διαθέσιμες επιλογές.
