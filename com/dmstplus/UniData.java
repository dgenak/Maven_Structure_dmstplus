...
public class UniData {
    ...
    public UniData() {
        ...
        universities.add(new University(6, "University of Southern Denmark", "Denmark", "Odense", 1250, 0, "Danish", "Spring"));
        universities.add(new University(7, "Abo Akademi University", "Finland", "Turku", 1000, 400.0, "Finnish", "Winter"));
        universities.add(new University(8, "Lahti University of Applied Sciences - LUT University - Lahti Campus", "Finland", "Lahti", 900, 0, "Finnish", "Winter"));
        universities.add(new University(9, "University of Vaasa", "Finland", "Vaasa", 900, 0, "Finnish", "Winter"));
        universities.add(new University(10, "University of Jyvaskyla", "Finland", "Jyvaskyla", 900, 0, "Finnish", "Winter"));
        ...
        universities.add(new University(13, "University of Clermont Auvergne", "France", "Clermont-Ferrand", 850, 0, "French", "Spring"));
        universities.add(new University(14, "Universite Paris Nanterre", "France", "Nanterre (Paris)", 1250, 700.0, "French", "Spring"));
        universities.add(new University(15, "Universite de Strasbourg Ecole de Management Strasbourg - EM Strasbourg Business School", "France", "Strasbourg", 1000, 0, "French", "Spring"));
        ...
        universities.add(new University(17, "University of Tours", "France", "Tours", 900, 0, "French", "Spring"));
        universities.add(new University(18, "SKEMA Business School", "France", "Sophia Antipolis", 1100, 0, "French", "Spring"));
        universities.add(new University(19, "University of Cologne", "Germany", "Cologne", 1050, 500.0, "German", "Spring"));
        universities.add(new University(20, "University of Mannheim", "Germany", "Mannheim", 1000, 0, "German", "Spring"));
        universities.add(new University(21, "Philipps-University Marburg", "Germany", "Marburg", 850, 0, "German", "Spring"));
        universities.add(new University(22, "University of Siegen", "Germany", "Siegen", 850, 0, "German", "Spring"));
        universities.add(new University(23, "Technische Univeristat Hamburg - Hamburg TUHH", "Germany", "Hamburg", 1200, 0, "German", "Spring"));
        universities.add(new University(24, "Technische Univeristat Munchen", "Germany", "Munich", 1400, 700.0, "German", "Spring"));
        universities.add(new University(25, "Univeristat ULM", "Germany", "Ulm", 950, 0, "German", "Spring"));
        universities.add(new University(26, "Technische Univeristat Dortmund", "Germany", "Dortmund", 950, 0, "German", "Spring"));
        universities.add(new University(27, "Universität Hamburg", "Germany", "Hamburg", 900, 0, "German", "Spring"));
        universities.add(new University(28, "SRH Hochshule Berlin - The International Management University", "Germany", "Berlin", 1150, 0, "German", "Spring"));
        universities.add(new University(29, "Univeristat Koblenz", "Germany", "Koblenz", 950, 450.0, "German", "Spring"));
        universities.add(new University(30, "Univeristat of Munster, School of Business and Economics", "Germany", "Munster", 1050, 0, "German", "Spring"));
        ...
        universities.add(new University(34, "Universita degli Studi di Torino", "Italy", "Turin", 850, 0, "Italian", "Spring"));
        ...
        universities.add(new University(36, "BI - Norwegian Business School", "Norway", "Oslo", 1500, 0, "Norwegian", "Winter"));
        universities.add(new University(37, "Norwegian School of Economics - NHH", "Norway", "Bergen", 1350, 0, "Norwegian", "Winter"));
        universities.add(new University(38, "Instituto Politecnico Da Guarda (IPG)", "Portugal", "Guarda", 600, 0, "Portuguese", "Spring"));
        ...
        universities.add(new University(42, "Kristianstad University", "Sweden", "Kalmar", 1000, 0, "Swedish", "Spring"));
    ...
    public List<University> letsGoErasmus(User user) {
        ...
        for (University university : universities) {
            ...
            if (university.getSharedAccomondation()) {
                ...
                if ((university.getCostWithSh_Accommondation() != 0) && (user.getMaxMonthlyCost() < university.getCostWithSh_Accomondation())) {
                    is_it_a_match = false;
                }
            } else {
